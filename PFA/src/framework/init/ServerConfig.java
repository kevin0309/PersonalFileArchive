...
public class ServerConfig {
	...
	static void setRootDirectory(String rootDirectory) {
		...
		LogUtil.printLog("The server storage root directory has been set to [" + rootDirectory + "].");
	}
	/**
	 * 서버 전역설정값
	...
	public static String getLogStackDirectory() {
		return rootDirectory + logStackDirectory;
	}
	/**
	 * 서버 전역설정값
	 ...
	 * @see framework.logs.LogStackService
	 */
	public static String getLogStackDirectory(boolean useAbsolutePath) {
		if (useAbsolutePath)
			return rootDirectory + logStackDirectory;
		else
